        ...
        .then(async function (data) {
          ...
          if (price == "" || price == null) {
            ...
            let listdata = {
              ...
              img: img,
              tokenid: tokenid,
              tokenad: "0xc68DC2f28b5D22C55e41ca9C956231a781489D5F",
              owner: owner,
            };
            ...
            async function transfer(listdata) {
              ...
              var ContractAddress =
                "0xc68DC2f28b5D22C55e41ca9C956231a781489D5F";
...
//       console.log(result);
//       if (result) {
//         Swal.fire("Wait for 2 minutes!", "to list your NFT!", "successfully");
//         fetch("http://217.160.146.227:3000/buynft", {
//           headers: {
//             "Content-type": "application/json; charset=UTF-8",
//           },
